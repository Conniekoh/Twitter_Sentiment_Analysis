...
#Tweets were collected at 10:06 am PST on June 26, 2021 on four twitter
library(rtweet)
...
# EXAMPLE: stemDocument(running,runs,ran) would return (run,run,ran) as the output.
...
#5. Scores all words
#By applying the afinn lexicon to the words in the tweets, we can compute a score fo reach tweet
#By averaging the scores of all tweets, one can obtain an overall sentiment score

#As you can see from the histogram, the highest value of sentiment score
tweets_words %>% 
